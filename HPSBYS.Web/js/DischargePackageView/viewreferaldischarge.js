...
function bindDischargeView(ele) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            //if (response.patientDetails.dischargedoc != null) {
            //    $('#dischargedoc').prop("disabled", false);
            //    $('#dischargedoc').addClass("btn btn-outline-success btn-sm");
            //    $('#dischargedoc').removeClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#dischargedoc').data('pathName', response.patientDetails.dischargedoc);
            //    $('#dischargedoc').data('filename', response.patientDetails.dischargedocname);
            //}
            //else {
            //    $('#dischargedoc').removeClass("btn btn-outline-success btn-sm");
            //    $('#dischargedoc').addClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#dischargedoc').prop("disabled", true);
            //}
            //if (response.patientDetails.intrasurgery != null) {
            //    $('#intrasurgery').prop("disabled", false);
            //    $('#intrasurgery').addClass("btn btn-outline-success btn-sm");
            //    $('#intrasurgery').removeClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#intrasurgery').data('pathName', response.patientDetails.intrasurgery);
            //    $('#intrasurgery').data('filename', response.patientDetails.intrasurgeryname);
            //}
            //else {
            //    $('#intrasurgery').removeClass("btn btn-outline-success btn-sm");
            //    $('#intrasurgery').addClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#intrasurgery').prop("disabled", true);
            //}
            //if (response.patientDetails.presurgery != null) {
            //    $('#presurgery').prop("disabled", false);
            //    $('#presurgery').addClass("btn btn-outline-success btn-sm");
            //    $('#presurgery').removeClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#presurgery').data('pathName', response.patientDetails.presurgery);
            //    $('#presurgery').data('filename', response.patientDetails.presurgeryname);
            //}
            //else {
            //    $('#presurgery').removeClass("btn btn-outline-success btn-sm");
            //    $('#presurgery').addClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#presurgery').prop("disabled", true);
            //}
            //if (response.patientDetails.postsurgery != null) {
            //    $('#postsurgery').prop("disabled", false);
            //    $('#postsurgery').addClass("btn btn-outline-success btn-sm");
            //    $('#postsurgery').removeClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#postsurgery').data('pathName', response.patientDetails.postsurgery);
            //    $('#postsurgery').data('filename', response.patientDetails.postsurgeryname);
            //}
            //else {
            //    $('#postsurgery').removeClass("btn btn-outline-success btn-sm");
            //    $('#postsurgery').addClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#postsurgery').prop("disabled", true);
            //}
            //if (response.patientDetails.specimenremoval != null) {
            //    $('#specimenremoval').prop("disabled", false);
            //    $('#specimenremoval').addClass("btn btn-outline-success btn-sm");
            //    $('#specimenremoval').removeClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#specimenremoval').data('pathName', response.patientDetails.specimenremoval);
            //    $('#specimenremoval').data('filename', response.patientDetails.specimenremovalname);
            //}
            //else {
            //    $('#specimenremoval').removeClass("btn btn-outline-success btn-sm");
            //    $('#specimenremoval').addClass("btn btn-outline-warning btn-sm user-select-none");
            //    $('#specimenremoval').prop("disabled", true);
            //}
