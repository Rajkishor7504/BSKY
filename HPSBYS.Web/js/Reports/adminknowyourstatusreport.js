        ...
        success: function (resultBal) {
            ...
            if (resultBal.length > 0) {
                var AddParameter = "<tr class='parent'>" +
                    ...
                    "<td><b class='text-success'>" + resultBal[0].memberid + "</b><div class='pre-bold'>" + resultBal[0].membername + "</div></td>" +
                    ...
                    "<td><button type='button' class='btn btn-outline-success focusedBtn btn-sm my-2 my-sm-0 detailsPanal' data-toggle='collapse' data-target='#pkgmodalcls_" + slno + "'><i class='fa fa-eye'></i></button></td></tr>";
                AddParameter += " </tr>";
